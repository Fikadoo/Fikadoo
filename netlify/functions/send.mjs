export default async (request) => {
  ...
  // Przy wejściu w /api/send z przeglądarki zobaczysz ten JSON.
...
<body style="margin:0;padding:0;background:#f4f7fb;font-family:Arial,Helvetica,sans-serif;color:#0b2b57;">
  <table role="presentation" width="100%" cellspacing="0" cellpadding="0" border="0" style="background:#f4f7fb;padding:30px 12px;">
    <tr>
      <td align="center">
        <table role="presentation" width="100%" cellspacing="0" cellpadding="0" border="0" style="max-width:640px;background:#ffffff;border-radius:22px;overflow:hidden;">
          <tr>
            <td align="center" style="padding:28px 30px 12px;">
              <img src="${logoUrl}" alt="Fikadoo" style="display:block;width:240px;max-width:80%;height:auto;margin:0 auto;">
            </td>
          </tr>

          <tr>
            <td align="center" style="padding:8px 30px 28px;">
              <div style="display:inline-block;background:#fff0f7;color:#ff2f8b;font-size:12px;font-weight:700;letter-spacing:1px;padding:8px 14px;border-radius:999px;">
                NOWE ZAPYTANIE
              </div>
          ...
          <tr>
            <td style="padding:0 30px 8px;">
              <table role="presentation" width="100%" cellspacing="0" cellpadding="0" border="0">
                ...
                ${mailRow('Rodzaj imprezy', safe(eventType || '-'))}
          ...
          <tr>
            <td style="padding:15px 30px 6px;">
              <div style="background:#fff3f8;border:1px solid #ffd5e6;border-radius:16px;padding:20px;">
                ...
                <div style="font-size:15px;line-height:1.65;color:#37475a;">
          ...
          <tr>
            <td align="center" style="padding:25px 30px 34px;">
              <a href="mailto:${safe(email)}" style="display:inline-block;background:#ff2f8b;color:#fff;text-decoration:none;padding:14px 26px;border-radius:999px;font-weight:800;">
                Odpowiedz klientowi
              </a>
            </td>
          </tr>
          ...
          <tr>
            <td>
              <table role="presentation" width="100%" cellspacing="0" cellpadding="0" border="0">
                <tr>
                  <td width="33%" height="8" style="background:#1685ef;font-size:0;">&nbsp;</td>
                  <td width="34%" height="8" style="background:#ff2f8b;font-size:0;">&nbsp;</td>
                  <td width="33%" height="8" style="background:#ffd21c;font-size:0;">&nbsp;</td>
                </tr>
              </table>
            </td>
          </tr>
          ...
          <tr>
            <td align="center" style="padding:18px 25px 22px;color:#9aa5b5;font-size:12px;">
    ...
    return Response.json({
      ok: false,
      message: error?.message || 'Nie udało się wysłać wiadomości.'
    }, {
      status: 500,
      headers: jsonHeaders
    });
...
function mailRow(label, value) {
  return `
    <tr>
      <td style="width:42%;padding:12px 14px;background:#f7f9fd;border-bottom:9px solid #fff;color:#718096;font-size:13px;font-weight:700;">
        ${label}
      </td>
      <td style="padding:12px 14px;background:#f7f9fd;border-bottom:9px solid #fff;color:#0b2b57;font-size:15px;">
        ${value}
      </td>
    </tr>
  `;
